...
public abstract class FeaturesDatabaseHelper extends SQLiteOpenHelper {
    ...
    public abstract boolean isAnalyzed( String recordingID );

    public abstract boolean insertFeatures( String recordingID, ArrayList< Pair< Integer, float[] > > featuresToStore );

    public abstract void removeFeatures( String recordingID );
}
